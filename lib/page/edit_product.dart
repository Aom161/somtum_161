...
class _EditProductState extends State<EditProduct> {
  ...
  Future<void> getProductById(int productId) async {
    ...
    print(productId);
    var url = Uri.parse(
        'https://642021161.pungpingcoding.online/api/product/$productId');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('แก้ไขข้อมูลเมนู'),
      ),
      body: Form(
        key: _editFormKey,
        child: mainInput(),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: const InputDecoration(
          ...
          label: Text(
            'ราคา',
            style: TextStyle(color: Color.fromARGB(255, 206, 76, 25)),
          ),
        ),
      ),
    );
      ...
      child: TextFormField(
        ...
        decoration: const InputDecoration(
          border: OutlineInputBorder(
            borderRadius: BorderRadius.all(Radius.circular(16)),
            borderSide:
                BorderSide(color: Color.fromARGB(255, 243, 110, 33), width: 2),
          ),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.all(Radius.circular(16)),
            borderSide:
  ...
  Future<void> updateProduct() async {
    ...
    if (_editFormKey.currentState!.validate()) {
      try {
        ...
        var url = Uri.parse(
            'https://642021161.pungpingcoding.online/api/product/$id');
