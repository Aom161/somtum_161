...
import 'package:somtum_161/page/add_product.dart';
import 'package:somtum_161/page/edit_product.dart';
...
class _ShowProductState extends State<ShowProduct> {
  ...
  Future<void> getList() async {
    products = [];
    var url = Uri.parse('https://642021161.pungpingcoding.online/api/product');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 236, 144, 5),
        actions: [
          Row(
            children: [
  ...
  Widget showButton() {
    return ElevatedButton(
      ...
      child: const Text('แสดงรายการเมนูอาหาร'),
    );
  }
            ...
            child: Column(
              children: [
                const Icon(
                  ...
                  color: Color.fromARGB(255, 230, 188, 100),
                  size: 60,
                ),
                Padding(
  ...
  Future<void> deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021161.pungpingcoding.online/api/product/$id');
  ...
  Future<void> logout(BuildContext context) async {
    ...
    var url = Uri.parse('https://642021161.pungpingcoding.online/api/logout');
